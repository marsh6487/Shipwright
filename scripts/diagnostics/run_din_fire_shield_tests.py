"""Compile the real fire-shield renderer against actual game headers and GBI."""
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="din-fire-shield-") as temp:
        binary = Path(temp) / "test"
        subprocess.run([os.environ.get("CC", "cc"), *flags,
                        "soh/tests/din_fire_shield_test.c", "soh/src/code/din_fire_shield.c",
