...
int main(void) {
    ...
    assert(StaticStoryActor_GetType(0x7F12) == STATIC_STORY_ACTOR_CHILD_MALON);
    assert(StaticStoryActor_GetPose(0x7F12) == 1);
    assert(StaticStoryActor_GetType(0x7F23) == STATIC_STORY_ACTOR_SARIA);
    assert(StaticStoryActor_GetPose(0x7F23) == 2);
