...
ConcurrentWeatherRainAction ConcurrentWeatherAudio_SelectRainAction(uint8_t ownsFallbackLoop, uint8_t enhancedOwnsRain,
    ...
    if (enhancedOwnsRain && !natureRainEnabled && gain > 0.0f) {
